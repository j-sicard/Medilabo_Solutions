...
public interface Microservicesproxy {
     ...
     */
	@GetMapping(value = "/MPATIENT/PatientRecord/patients")
     ...
     */
	@GetMapping(value = "/MPATIENT/PatientRecord/patient/{firstname}/{lastname}")
     ...
     */
	@PostMapping(value = "/MPATIENT/PatientRecord/create")
     ...
     * @return ResponseEntity indicating the success or failure of the operation.
     */
	@PutMapping(value = "/MPATIENT/PatientRecord/patient/update")
     ...
     */
	@GetMapping(value = "/MPATIENT/user/{username}")
     ...
     */
	@GetMapping("/MPATIENT/user/users")
     ...
     */
	@PostMapping("/MPATIENT/user/save")
